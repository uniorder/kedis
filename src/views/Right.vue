      ...
      <div class="row mt-3">
        ...
        <div class="col-10">
          <div style="text-align: center">
            <a href="javascript:;">
              <img
                src="https://gitee.com/kehaw9818/Kedis/widgets/widget_3.svg"
                alt="Fork me on Gitee"
              />
            </a>
            <br />
            <br />
            <p>Powered by <span>Kehaw</span></p>
            <a
              href="javascript:;"
              @click="
                openBrowser('https://gitee.com/kehaw9818/Kedis/stargazers')
              "
            >
              <img
                src="https://gitee.com/kehaw9818/Kedis/badge/star.svg?theme=dark"
                alt="star"
              />
            </a>
            &nbsp;
            <a
              href="javascript:;"
              @click="openBrowser('https://gitee.com/kehaw9818/Kedis/members')"
            >
              <img
                src="https://gitee.com/kehaw9818/Kedis/badge/fork.svg?theme=dark"
                alt="fork"
              />
            </a>
          </div>
