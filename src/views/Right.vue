<template>
  <div class="main-right">
    <value-string v-show="this.type === 'string'" ref="valueString"></value-string>
    ...
    <div style="height:100%; overflow:auto;">
      <div class="my-descriptions mt-4" v-show="this.type === 'default'">
        <div class="avatar">
        ...
        <div class="social">
          <a href="javascript:;" @click="openBrowser('https://twitter.com/Kehaw2')" class="text-success">
            <i class="fab fa-twitter-square"></i> &nbsp;&nbsp;
            <span>@Kehaw2</span>
          </a>
          <a href="javascript:;" @click="openBrowser('https://github.com/uniorder')" class="text-warning">
            <i class="fab fa-github-square"></i> &nbsp;&nbsp;
            <span>Uniorder</span>
          </a>
          <a href="javascript:;" @click="openBrowser('http://www.kehaw.com')" class="text-info">
        ...
        <div class="description border-top">
          <p>
            <a href="javascript:;" style="font-size:18px;" @click="openBrowser(repoData.html_url)">{{ repoData.name }}: </a>{{ repoData.description }}
          </p>
          <p>{{ repoData.license ? repoData.license.key : "" }}</p>
          <button class="btn btn-sm btn-success" @click="openBrowser('https://github.com/uniorder/kedis/stargazers')">
            <i class="fa fa-star"></i>
            {{ repoData.stargazers_count }} stars
          </button>
          <button class="btn btn-sm btn-primary" @click="openBrowser(repoData.forks_url)">
...
export default class Right extends Vue {
  ...
  public created() {
    ...
    axios.get("https://api.github.com/repos/uniorder/kedis").then((response: any) => {
